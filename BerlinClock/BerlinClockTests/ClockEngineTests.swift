...
struct ClockEngineTests {
    ...
    func testThreeOneHourLampsAreOn(hours: Int) {
        #expect(clockEngine.computeOneHourRow(hour: hours) == [.red, .red, .red, .off])
    }

    @Test("All 1-hour lamps are on on hours ending with 4 or 9", arguments: [4, 9, 14, 19])
    func testAllOneHourLampsAreOn(hours: Int) {
        #expect(clockEngine.computeOneHourRow(hour: hours) == [.red, .red, .red, .red])
    }
    ...
    func testAllOneMinuteLampsAreOff(minutes: Int) {
        #expect(clockEngine.computeOneMinuteRow(minute: minutes) == [.off, .off, .off, .off])
    }
    ...
    func testSingleOneMinuteLampIsOn(minutes: Int) {
        #expect(clockEngine.computeOneMinuteRow(minute: minutes) == [.yellow, .off, .off, .off])
    }
    ...
    func testTwoOneMinuteLampsAreOn(minutes: Int) {
        #expect(clockEngine.computeOneMinuteRow(minute: minutes) == [.yellow, .yellow, .off, .off])
    }
    ...
    func testThreeOneMinuteLampsAreOn(minutes: Int) {
        #expect(clockEngine.computeOneMinuteRow(minute: minutes) == [.yellow, .yellow, .yellow, .off])
    }
    ...
    func testAllOneMinuteLampsAreOn(minutes: Int) {
        #expect(clockEngine.computeOneMinuteRow(minute: minutes) == [.yellow, .yellow, .yellow, .yellow])
    }
}
