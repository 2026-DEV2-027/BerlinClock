...
struct ClockEngineTests {
    ...
    func testAllOneMinuteLampsAreOff(minutes: Int) {
        #expect(sut.computeOneMinuteRow(for: minutes) == [.off, .off, .off, .off])
    }
    ...
    func testSingleOneMinuteLampIsOn(minutes: Int) {
        #expect(sut.computeOneMinuteRow(for: minutes) == [.yellow, .off, .off, .off])
    }
    ...
    func testTwoOneMinuteLampsAreOn(minutes: Int) {
        #expect(sut.computeOneMinuteRow(for: minutes) == [.yellow, .yellow, .off, .off])
    }
    ...
    func testThreeOneMinuteLampsAreOn(minutes: Int) {
        #expect(sut.computeOneMinuteRow(for: minutes) == [.yellow, .yellow, .yellow, .off])
    }
    ...
    func testAllOneMinuteLampsAreOn(minutes: Int) {
        #expect(sut.computeOneMinuteRow(for: minutes) == [.yellow, .yellow, .yellow, .yellow])
    }
}
